...
import s from './subscribe-alert-card.module.scss';

interface ISubscribeAlertCard {
	imgs: string[];
	logo: string;
	title: string;
	tags: string[];
...
export const SubscribeAlertCard: FC<ISubscribeAlertCard> = ({ imgs, logo, title, tags, descr }) => {
	...
	const subscribeClass = clsx(s.subscribeAlertCard);
